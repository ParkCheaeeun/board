      ...
      <div class="row">
		...
		<div class="container" role="main">
				...
				<% if(request.getParameter("post_no") == null){ %>
					<form id="frm" action="${pageContext.request.contextPath}/PostInsert" method="post" enctype="multipart/form-data">
				...
				<%}else{ %>
					<form id="frm" action="${pageContext.request.contextPath}/writePost" method="post" enctype="multipart/form-data">
						<input type="hidden" value="<%= request.getParameter("board_no") %>" name="board_no">
						...
						<div class="mb-3">
							<label for="title">제목</label>
							<input type="text" style="width : 770px;" class="form-control" name="title" id="title" placeholder="제목을 입력해 주세요"
							value="<%= request.getParameter("post_title")%>">
						</div><br>
						<textarea name="ir1" id="ir1" rows="10" cols="100" style="width:766px; height:412px; display:none;"></textarea>
					...
					nhn.husky.EZCreator.createInIFrame({
						...
						fOnAppLoad : function(){
							if($('#hiddenInput').val() != 'null'){
								oEditors.getById["ir1"].exec("PASTE_HTML", [$('#hiddenInput').val()]);
							}
